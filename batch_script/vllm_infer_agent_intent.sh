#!/bin/bash
#SBATCH --job-name=fsdrive_vllm_infer_agent_intent
#SBATCH --partition=a100
#SBATCH --gres=gpu:2
#SBATCH --cpus-per-task=32
#SBATCH --time=1-00:00:00
#SBATCH --output=logs/vllm_infer_agent_intent_%j.out
#SBATCH --error=logs/vllm_infer_agent_intent_%j.err
...
SAVE_NAME=eval_results/results_no_drivelm_agent_intent.jsonl
