...
PRED_PATH=LlamaFactory/eval_results/results_sft_three_datasets_no_drivelm.jsonl
EVAL_TRAJ_PATH=LlamaFactory/eval_results/eval_traj_sft_three_datasets_no_drivelm_val_cot_motion.json
...
python tools/evaluation/evaluation.py \
  --method FSDrive-sft-three-datasets-no-drivelm \
  --metric uniad \
