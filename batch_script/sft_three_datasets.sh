#!/bin/bash
#SBATCH --job-name=fsdrive_sft_three_datasets_no_drivelm
#SBATCH --partition=a100
#SBATCH --gres=gpu:4
#SBATCH --cpus-per-task=64
#SBATCH --time=1-00:00:00
#SBATCH --output=logs/sft_three_datasets_no_drivelm_%j.out
#SBATCH --error=logs/sft_three_datasets_no_drivelm_%j.err
...
llamafactory-cli train ../configs/sft_three_datasets.yaml
