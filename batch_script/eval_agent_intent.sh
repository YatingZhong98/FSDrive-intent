#!/bin/bash
#SBATCH --job-name=fsdrive_eval_agent_intent
#SBATCH --partition=a100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=16
#SBATCH --time=1-00:00:00
#SBATCH --output=logs/eval_agent_intent_%j.out
#SBATCH --error=logs/eval_agent_intent_%j.err
...
PRED_PATH=LlamaFactory/eval_results/results_no_drivelm_agent_intent.jsonl
EVAL_TRAJ_PATH=LlamaFactory/eval_results/eval_traj_sft_no_drivelm_agent_intent_val_cot_motion_agent_intent.json
