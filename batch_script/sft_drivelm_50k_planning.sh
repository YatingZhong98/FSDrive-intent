#!/bin/bash
#SBATCH --job-name=fsdrive_sft_drv50k
#SBATCH --partition=a100
#SBATCH --gres=gpu:4
#SBATCH --cpus-per-task=64
#SBATCH --time=1-00:00:00
#SBATCH --output=logs/sft_drivelm50k_%j.out
#SBATCH --error=logs/sft_drivelm50k_%j.err
...
llamafactory-cli train ../configs/sft_drivelm_50k_planning.yaml
