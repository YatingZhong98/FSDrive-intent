...
system = "You're an autonomous vehicle's brain. Coordinates: X-axis is perpendicular, and Y-axis is parallel to the direction you're facing. You're at point (0,0). Units: meters. Based on the provided particulars and latent surrounding vehicle intentions, please output the CAM_FRONT image at the 0.5 second in the future and plan waypoints (0.5s intervals) for the next 3 seconds."
...
parser = argparse.ArgumentParser(description="Build SFT data with GT surrounding vehicle intentions in the prompt.")
parser.add_argument("--split", type=str, default="train", choices=["train", "val"])
parser.add_argument("--agent_intent_labels", type=str, default="./create_data/agent_intent_labels_k64_top4.json")
parser.add_argument("--output_suffix", type=str, default="agent_intent_prompt")
...
for token in tokens:
    ...
    human_value = (
        ...
        + user_message
        + "The latent surrounding vehicle intentions are: "
        + agent_intent_token
        + "\nBased on the provided particulars and latent surrounding vehicle intentions, please output the CAM_FRONT image at the 0.5 second in the future and plan waypoints (0.5s intervals) for the next 3 seconds.\n"
    )
    assistant_value = (
        next_img_token
